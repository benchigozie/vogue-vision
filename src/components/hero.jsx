...
function Home () {
    ...
    return (
        ...
        <section id="hero" className="relative">
            <div className="bg-[url('https://ik.imagekit.io/zjcuhh7cp/interior%20design/pexels-fotoaibe-1643383%20(1).png?')]  w-full bg-cover bg-center bg-no-repeat animate-opac pt-16">
                <div className="flex flex-col py-28 px-10 font-lora w-full md:block md:px-8 md:py-32 text-vwhite alg:py-28 alg:px-10   lg:px-20 animate-opac duration-1000">
                    <div className="flex">
            ...
            <div className="flex justify-center gap-4 py-4">
                <div className="bg-vblack w-2 h-2 rounded-full cursor-pointer"></div>
                <div className="bg-vblack w-2 h-2 rounded-full cursor-pointer"></div>
                <div className="bg-vblack w-2 h-2 rounded-full cursor-pointer"></div>
            </div>
        </section>
